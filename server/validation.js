...
export const querySchema = z.object({ page: z.coerce.number().int().min(1).max(100000).default(1), filter: z.enum(['ALL','PENDING','APPROVED','REJECTED','IMPORTED']).default('ALL'), search: z.string().trim().max(200).default('') });
